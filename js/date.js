...
(function ($) {      
    $.fn.date = function (options,Ycallback,Ncallback) {   
        ...
        var initY=parseInt((nowdate.getYear()+"").substr(1,2)) + 50;
        if(initY >= 100){
        	initY = initY -100;
        }
	...
	function resetIndex(){
        ...
        function resetInitDete(){
            ...
            initY = parseInt(that.val().substr(2,2)) + 50;
            if(initY >= 100){
	        	initY = initY -100;
	        }
        ...
        function bindButton(){
            ...
            $("#dateconfirm").unbind('click').click(function () {	
			  ...
			  $("#daywrapper ul li:eq("+Math.ceil(indexD)+")").html().substr(0,$("#daywrapper ul li:eq("+Math.ceil(indexD)+")").html().length-1);
               if(datetime){
