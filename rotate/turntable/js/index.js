...
$(document).ready(function(){
    ...
    */
    ...
    turnWheel.images = [
    "~/../images/123.png","~/../images/100.png",
     "~/../images/10.png","~/../images/100.png",
     "~/../images/301.png","~/../images/100.png",
     "~/../images/qb.png","~/../images/100.png",
     "~/../images/qb.png","~/../images/100.png"
     ];
...
//    var canvas = ($("#wheelCanvas")).get()[0]; // 注意，jQuery获取的是包装过的对象，不是DOM对象,可以进行转换
    ...
    for(var index = 0 ; index < turnWheel.rewardNames.length ; index++)
    {
         ...
         * */
        if(rewardName.indexOf("")>0){//查询是否包含字段 流量包
        ...
        var imgSorry = new Image();
		imgSorry.src = turnWheel.images[index];
		 imgSorry.onload=function(){
//          ctx.drawImage(imgSorry,-15,10);
        };
        ctx.drawImage(imgSorry,-15,0);
